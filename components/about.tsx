      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-4 text-base leading-relaxed">
            ...
            <a
              href="#contact"
              className="inline-flex items-center gap-2 mt-2 rounded-full border-2 border-blue-500/60 dark:border-blue-500/40 bg-blue-500/15 dark:bg-blue-500/10 backdrop-blur-sm px-5 py-2 text-sm text-blue-700 dark:text-blue-300 hover:bg-blue-500/25 dark:hover:bg-blue-500/20 hover:border-blue-600/70 dark:hover:border-blue-500/60 transition-all font-semibold"
            >

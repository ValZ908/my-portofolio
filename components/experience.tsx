        ...
        <div className="relative">
          ...
          <ol className="space-y-10 pl-12">
            <li className="relative">
              ...
              <div className="rounded-xl border border-white/10 bg-white/5 backdrop-blur-sm p-5 hover:border-white/20 transition-all">
                <div className="flex flex-wrap items-start justify-between gap-2 mb-2">
                  ...
                  <div className="flex flex-col items-end gap-1">
                    ...
                    <span className="text-[10px] font-medium uppercase tracking-wide px-2 py-0.5 rounded-full border border-blue-500/30 bg-blue-500/10 text-blue-300">
                      Education
                    </span>
                  </div>
                </div>
